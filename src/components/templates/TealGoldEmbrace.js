        ...
        >
          ...
          {isExpired ? (
            <motion.div
              variants={gentleFloat}
              custom={1}
              className="rounded-2xl border border-teal-800/20 bg-teal-50/80 p-6 shadow-sm"
            >
              <div className="mb-2 flex items-center justify-center gap-2">
                ...
                <Editable
                  ...
                  onEdit={onEdit}
                  editable={editable}
                  className="text-lg font-medium tracking-wide text-teal-950 sm:text-xl"
              ...
              <Editable
                ...
                onEdit={onEdit}
                editable={editable}
                className="mx-auto max-w-sm text-xs leading-relaxed text-teal-900/70 sm:text-sm"
