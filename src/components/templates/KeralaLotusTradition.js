...
// Unique animation style for this template
const warmRise = {
...
export default function KeralaLotusTradition({
  data = {},
  onEdit = () => {},
  editable = false,
  className = '',
  ...
  const countdownTitle =
    data.countdownTitle || 'The Auspicious Occasion';
    ...
    >
      ...
      <div className="fixed top-3 right-3 z-50 flex items-center gap-2">
        <motion.button
          whileTap={{ scale: 0.92 }}
          onClick={toggleAudio}
          className="flex h-10 w-10 items-center justify-center rounded-full border border-amber-200 bg-white/90 text-amber-800 shadow-sm backdrop-blur-md"
        >
        ...
        <motion.button
          ...
          className="flex h-10 items-center gap-1.5 rounded-full border border-amber-200 bg-white/90 px-3 text-xs tracking-wide text-amber-900 shadow-sm backdrop-blur-md"
        >
          {copied ? (
            <>
      ...
      <section className="relative w-full overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img
            src="https://i.pinimg.com/736x/01/7c/a4/017ca4d93a0f295f0e1d1bc3b4199be0.jpg"
            alt=""
            className="h-full w-full object-cover object-top"
            loading="eager"
          />
          <div className="absolute inset-0 bg-gradient-to-b from-white/5 via-transparent to-[#fdf8f2]" />
        </div>
        ...
        <div className="relative z-10 mx-auto flex min-h-[94vh] max-w-lg flex-col items-center justify-end px-5 pb-40 pt-28 text-center sm:pb-44">
          ...
          >
            ...
            >
              <div className="h-px w-8 bg-amber-300/70" />
              <span className="text-amber-600 text-base">🪔</span>
              <div className="h-px w-8 bg-amber-300/70" />
            </motion.div>

            {/* ===== GROOM + PARENTS ===== */}
            <motion.div variants={warmRise} custom={1}>
              <Editable
                tag="h1"
                value={groomName}
                field="groomName"
            ...
            <motion.div variants={warmRise} custom={2}>
              <Editable
                tag="p"
                value={groomParents}
                field="groomParents"
            ...
            {/* ===== BRIDE + PARENTS ===== */}
            <motion.div variants={warmRise} custom={4}>
              <Editable
                tag="h1"
                value={brideName}
                field="brideName"
            ...
            <motion.div variants={warmRise} custom={5}>
              <Editable
                tag="p"
                value={brideParents}
                field="brideParents"
            ...
            {/* Event text */}
            <motion.div variants={warmRise} custom={6} className="mt-5">
              <Editable
                tag="p"
                value={heroEventText}
                field="heroEventText"
            ...
            >
              <div className="flex items-center gap-2 rounded-full border border-amber-200/80 bg-white/75 px-4 py-1.5 backdrop-blur-sm">
      ...
      <div className="relative z-10 mx-auto max-w-lg px-5 pb-20">
        ...
        >
          <motion.div variants={warmRise} custom={0}>
            <Editable
              tag="h2"
              ...
              placeholder="The Auspicious Occasion"
            />
          </motion.div>
          ...
          <div className="grid grid-cols-4 gap-2.5">
            {[
              ...
              <motion.div
                ...
                variants={gentlePop}
                custom={i}
                className="flex flex-col items-center rounded-2xl border border-amber-100 bg-white py-3.5 shadow-sm"
              >
        ...
        <motion.section
          ...
          viewport={{ once: true, margin: '-50px' }}
          variants={warmRise}
          className="mt-12 rounded-3xl border border-amber-100 bg-white p-6 shadow-sm"
        >
          <motion.div
            variants={warmRise}
            custom={0}
          ...
          <motion.div variants={warmRise} custom={3}>
            <a
        ...
        >
          <motion.div
            variants={gentlePop}
            className="mb-4 flex items-center justify-center rounded-full border border-amber-200 bg-white text-sm font-medium tracking-widest text-amber-900 shadow-sm"
