...
export default function MaroonArchIslamic({
  data = {},
  onEdit = () => {},
  editable = false,
  className = '',
  ...
  const countdownTitle =
    data.countdownTitle || 'The Blessed Day';
...
<section id="hero-section" className="relative w-full overflow-hidden">
  <div className="absolute inset-0 z-0">
    <img
      src="https://i.pinimg.com/736x/5f/69/24/5f6924a1348ea74e7d454723f4309edb.jpg"
      alt=""
  ...
  <div className="relative z-10 mx-auto flex min-h-[92vh] max-w-lg flex-col items-center justify-end px-5 pb-36 pt-32 text-center sm:pb-40">
    <motion.div
      initial="hidden"
      animate="visible"
    ...
    >
      ...
      {/* ===== GROOM + PARENTS ===== */}
      <motion.div variants={gracefulRise} custom={1}>
        <Editable
          tag="h1"
          value={groomName}
          field="groomName"
          onEdit={onEdit}
          editable={editable}
          className="text-[clamp(1.85rem,9.5cqw,2.5rem)] font-normal tracking-[0.08em] text-rose-950 break-words leading-[1.1]"
          placeholder="Groom Name"
        />
      </motion.div>

      <motion.div variants={gracefulRise} custom={2}>
        <Editable
          tag="p"
          value={groomParents}
          field="groomParents"
      ...
      {/* ===== BRIDE + PARENTS ===== */}
      <motion.div variants={gracefulRise} custom={4}>
        <Editable
          tag="h1"
          value={brideName}
          field="brideName"
      ...
      <motion.div variants={gracefulRise} custom={5}>
        <Editable
          tag="p"
          value={brideParents}
          field="brideParents"
      ...
      {/* Event text */}
      <motion.div variants={gracefulRise} custom={6} className="mt-5">
        <Editable
          tag="p"
          value={heroEventText}
          field="heroEventText"
      ...
      <div className="relative z-10 mx-auto max-w-lg px-5 pb-20">
        ...
        >
          <motion.div variants={gracefulRise} custom={0}>
            <Editable
              tag="h2"
          ...
          {isExpired ? (
            <motion.div
              variants={gracefulRise}
              custom={1}
              className="rounded-2xl border border-amber-500/30 bg-zinc-900/90 p-6 shadow-md"
            >
              <div className="mb-2 flex items-center justify-center gap-2">
                ...
                <Editable
                  ...
                  onEdit={onEdit}
                  editable={editable}
                  className="text-lg font-medium tracking-wide text-amber-200 sm:text-xl"
              ...
              <Editable
                ...
                onEdit={onEdit}
                editable={editable}
                className="mx-auto max-w-sm text-xs leading-relaxed text-stone-300 sm:text-sm"
        ...
        >
          ...
          <motion.div variants={gracefulRise} custom={3}>
            <a
