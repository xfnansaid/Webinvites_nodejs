        ...
        >
          ...
          {isExpired ? (
            <motion.div
              variants={goldenRise}
              custom={1}
              className="rounded-2xl border border-amber-500/25 bg-amber-50/90 p-6 shadow-sm"
            >
              ...
              <Editable
                ...
                onEdit={onEdit}
                editable={editable}
                className="mx-auto max-w-sm text-xs leading-relaxed text-amber-900/75 sm:text-sm"
