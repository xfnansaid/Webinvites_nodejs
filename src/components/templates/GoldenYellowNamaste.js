...
export default function GoldenYellowNamaste({
  data = {},
  onEdit = () => {},
  editable = false,
  className = '',
    ...
    >
      ...
      <div className="fixed top-3 right-3 z-50 flex items-center gap-2">
        <motion.button
          whileTap={{ scale: 0.92 }}
          onClick={toggleAudio}
          className="flex h-10 w-10 items-center justify-center rounded-full border border-amber-300/70 bg-white/90 text-amber-800 shadow-sm backdrop-blur-md"
        >
        ...
        <motion.button
          ...
          className="flex h-10 items-center gap-1.5 rounded-full border border-amber-300/70 bg-white/90 px-3 text-xs tracking-wide text-amber-900 shadow-sm backdrop-blur-md"
        >
          {copied ? (
            <>
      ...
      <section className="relative w-full overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img
            src="https://i.pinimg.com/1200x/25/d0/c4/25d0c4cb78faf6d2f42fea9bac44fd24.jpg"
            alt=""
            className="h-full w-full object-cover object-top"
            loading="eager"
          />
          <div className="absolute inset-0 bg-gradient-to-b from-white/5 via-transparent to-[#fdf8ef]" />
        </div>
        ...
        <div className="relative z-10 mx-auto flex min-h-[94vh] max-w-lg flex-col items-center justify-end px-5 pb-40 pt-28 text-center sm:pb-44">
          ...
          >
            ...
            {/* ===== GROOM + PARENTS ===== */}
            <motion.div variants={goldenRise} custom={1}>
              <Editable
                tag="h1"
                value={groomName}
                field="groomName"
            ...
            <motion.div variants={goldenRise} custom={2}>
              <Editable
                tag="p"
                value={groomParents}
                field="groomParents"
            ...
            {/* ===== BRIDE + PARENTS ===== */}
            <motion.div variants={goldenRise} custom={4}>
              <Editable
                tag="h1"
                value={brideName}
                field="brideName"
            ...
            <motion.div variants={goldenRise} custom={5}>
              <Editable
                tag="p"
                value={brideParents}
                field="brideParents"
            ...
            {/* Event text */}
            <motion.div variants={goldenRise} custom={6} className="mt-5">
              <Editable
                tag="p"
                value={heroEventText}
                field="heroEventText"
            ...
            >
              <div className="flex items-center gap-2 rounded-full border border-amber-300/70 bg-white/75 px-4 py-1.5 backdrop-blur-sm">
      ...
      <div className="relative z-10 mx-auto max-w-lg px-5 pb-20">
        ...
        >
          <motion.div variants={goldenRise} custom={0}>
            <Editable
              tag="h2"
        ...
        >
          ...
          <motion.div variants={goldenRise} custom={3}>
            <a
              href={canonicalMapUrl}
              target="_blank"
              rel="noopener noreferrer"
              className="mt-5 flex w-full items-center justify-center gap-2 rounded-full bg-amber-700 py-2.5 text-[13px] font-medium tracking-wide text-white transition hover:bg-amber-800 active:scale-[0.98]"
            >
        ...
        >
          <motion.div
            variants={softBloom}
            className="mb-4 flex items-center justify-center rounded-full border border-amber-300/70 bg-white text-sm font-medium tracking-widest text-amber-900 shadow-sm"
          ...
          <motion.div
            variants={goldenRise}
            custom={2}
            className="mt-5 flex items-center gap-2 text-amber-500"
          >
            <span className="text-sm">✦</span>
