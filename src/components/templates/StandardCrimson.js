    ...
    >
      ...
      <div className="fixed top-3 right-3 z-50 flex items-center gap-2">
        <motion.button
          whileTap={{ scale: 0.92 }}
          onClick={toggleAudio}
          className="flex h-10 w-10 items-center justify-center rounded-full border border-amber-400/40 bg-black/50 text-amber-200 backdrop-blur-md"
        >
        ...
        <motion.button
          ...
          className="flex h-10 items-center gap-1.5 rounded-full border border-amber-400/40 bg-black/50 px-3 text-xs tracking-wide text-amber-100 backdrop-blur-md"
        >
          {copied ? (
            <>
