...
export default function WeddingInvitation({
  ...
  const receptionTime =
    data.receptionTime || DEFAULT_DATA.receptionTime;
  const heroEventText =
    data.heroEventText || DEFAULT_DATA.heroEventText || 'as we embark on this beautiful journey together';
  ...
  const handleEdit = (field, value) => {
    ...
    } else if (field === 'receptionTime') {
      onEdit('receptionTime', value);
    } else if (field === 'heroEventText') {
