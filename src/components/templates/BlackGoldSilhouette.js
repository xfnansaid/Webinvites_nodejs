    ...
    >
      ...
      <div className="fixed top-4 right-4 z-50 flex items-center gap-2">
        <motion.button
          whileTap={{ scale: 0.9 }}
          onClick={toggleAudio}
          className="flex h-10 w-10 items-center justify-center rounded-full border border-amber-500/40 bg-black/70 text-amber-400 backdrop-blur-md"
        >
        ...
        <motion.button
          ...
          className="flex h-10 items-center gap-1.5 rounded-full border border-amber-500/40 bg-black/70 px-3 text-xs tracking-wider text-amber-300 backdrop-blur-md"
        >
          {copied ? (
            <>
