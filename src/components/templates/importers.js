...
const templateImporters = {
  ...
  // Birthday templates
  'birthday-royal-gold': () => import('./BirthdayRoyalGold'),
  'birthday-floral-blush': () => import('./BirthdayFloralBlush'),
  'birthday-modern-neon': () => import('./BirthdayModernNeon'),
  'birthday-fun-tropical': () => import('./BirthdayFunTropical'),
  'birthday-kids-colorful': () => import('./BirthdayKidsColorful'),
  // House Warming templates
  'housewarming-traditional': () => import('./HouseWarmingTraditional'),
  'housewarming-modern-green': () => import('./HouseWarmingModernGreen'),
  'housewarming-south-indian': () => import('./HouseWarmingSouthIndian'),
  'housewarming-minimal-cream': () => import('./HouseWarmingMinimalCream'),
  'housewarming-festive-red': () => import('./HouseWarmingFestiveRed'),
};
