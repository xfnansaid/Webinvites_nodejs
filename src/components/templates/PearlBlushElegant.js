    ...
    >
      ...
      <div className="fixed top-3 right-3 z-50 flex items-center gap-2">
        <motion.button
          whileTap={{ scale: 0.92 }}
          onClick={toggleAudio}
          className="flex h-10 w-10 items-center justify-center rounded-full bg-white/90 backdrop-blur-md shadow-md border border-stone-200 text-stone-600"
        >
        ...
        <motion.button
          ...
          className="flex h-10 items-center gap-1.5 rounded-full bg-white/90 backdrop-blur-md px-3 shadow-md border border-stone-200 text-stone-700 text-xs tracking-wide"
        >
          {copied ? (
            <>
