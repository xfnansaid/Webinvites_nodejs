...
const Editable = ({
  ...
  if (isEditing) {
    const common = {
      ...
      className: `outline-none bg-white/10 ring-2 ring-amber-400/60 rounded px-2 py-0.5 ${className}`,
      placeholder
    };
    return multiline ? (
      <textarea
  ...
  return (
    <Tag
      ...
      className={`cursor-pointer outline-none ring-0 hover:ring-2 hover:ring-amber-400/40 rounded transition-all ${className}`}
      title="Click to edit"
    >
...
export default function WeddingTemplate({
  ...
  return (
    <div style={{ containerType: 'inline-size', width: '100%', maxWidth: '100%', margin: 0, padding: 0 }}  className="relative min-h-screen bg-[#061412] text-[#F7F5F0] font-sans overflow-x-hidden antialiased selection:bg-[#D4AF37]/30 selection:text-[#F4E096]">
      ...
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Amiri:ital,wght@0,400;0,700;1,400&family=Cinzel:wght@400;500;600;700&family=Noto+Serif+Malayalam:wght@400;600&family=Plus+Jakarta+Sans:wght@300;400;500;600&display=swap');
        
        .font-cinzel { font-family: 'Cinzel', serif; }
        .font-amiri { font-family: 'Amiri', serif; }
        .font-malayalam { font-family: 'Noto Serif Malayalam', serif; }
