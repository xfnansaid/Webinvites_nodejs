  ...
  return (
    <main style={{ containerType: 'inline-size', width: '100%', maxWidth: '100%', margin: 0, padding: 0 }}  className="relative min-h-screen overflow-x-hidden bg-[#f8f9fa] font-['Poppins'] text-[#333333]">
      ...
      {/* FOOTER */}
        ...
        {/* RSVP Section */}
        <RsvpSection
          groomName={data?.groomName || invitation.groomName || 'Groom'}
          brideName={data?.brideName || invitation.brideName || 'Bride'}
          whatsappNumber={(data && (data.whatsappNumber || data.phone || data.whatsapp)) || invitation.whatsappNumber || ''}
        />
