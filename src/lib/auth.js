...
//
// Add more admins here as needed (strings are case-insensitively compared,
// trimmed, and matched against the user's Supabase verified email).
...
export function isAdminUser(user) {
  ...
  return isAdminEmail(user?.user_metadata?.email);
}
