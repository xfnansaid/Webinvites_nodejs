            ...
            <div className="p-4 sm:p-5 rounded-2xl bg-white/10 border border-white/15 backdrop-blur-sm">
              ...
              <ul className="space-y-1.5 text-xs text-stone-300">
                <li className="flex items-start gap-2">
                  ...
                  <span>Free invitation publishing with ads</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="w-1 h-1 rounded-full bg-emerald-400 mt-1.5 shrink-0" />
                  <span>Includes partner and sponsor ads</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="w-1 h-1 rounded-full bg-emerald-400 mt-1.5 shrink-0" />
            ...
            <div className="space-y-4 mt-4">
              <div className="p-4 rounded-2xl bg-emerald-50/70 border border-emerald-200/80">
                ...
                <ul className="list-disc pl-6 space-y-1.5 text-sm text-emerald-800/90">
                  <li>Publish digital wedding invitations at no cost on the <strong>Free Tier</strong>.</li>
                  <li>Free tier invitations <strong>include advertisements and partner sponsorships</strong> (Google AdSense / ad network banners / sponsor spotlights) to support the free hosting.</li>
                  ...
                  <li>You can manage or delete your invitations from your Dashboard at any time.</li>
                </ul>
              </div>
