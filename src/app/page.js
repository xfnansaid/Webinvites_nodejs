...
const faqs = [
  ...
  { q: "How long will my digital invitation stay live?", a: "Your digital invitation will remain live and active until 3 days after your event date, giving your guests plenty of time to view directions and celebrate with you before, during, and right after the wedding." },
  ...
  { q: "Can I add a couple photo, program sequence, or RSVP form?", a: "Yes! Every template includes optional sections for a Couple Photo (with automatic photo compression), Program of Celebrations (Date, Muhurtham/Ceremony, and Reception timings), and a WhatsApp RSVP form. You can easily keep or hide any of these sections using the editor toolbar." },
  { q: "Can I edit my invitation after publishing?", a: "Yes! You can make edits up to 3 times to your live invitation directly from your dashboard (e.g., to update dates, timing, or venue details). Any edits update your live link instantly without changing the URL." },
  { q: "How do my guests reach the venue?", a: "Every template includes a Get Directions button that opens Google Maps (or your custom maps URL) with a single tap for effortless navigation." }
];
...
export default function HomePage() {
  ...
  const jsonLdData = useMemo(() => [
    ...
    },
    {
      ...
      name: 'Web Invites',
      url: 'https://www.webinvites.shop',
      logo: 'https://www.webinvites.shop/og-wedding-default.jpg',
      contactPoint: {
        '@type': 'ContactPoint',
    ...
    },
    {
      '@context': 'https://schema.org',
      '@type': 'Product',
      name: 'Digital Wedding & Event Invitations',
      image: 'public/hero_layer.png',
      description: 'Create interactive wedding websites in minutes. 25+ templates at flat ₹299 with live countdown, Google Maps navigation, photo uploads, and WhatsApp sharing.',
      brand: {
        '@type': 'Brand',
        name: 'Web Invites',
      },
          ...
          <div className="relative max-w-[1400px] mx-auto px-4 md:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
              ...
              <div className="lg:col-span-7 flex flex-col items-center lg:items-start text-center lg:text-left space-y-6 lg:space-y-7">
                ...
                >
                  Choose from 25+ luxury wedding templates, edit live directly on screen, and get your custom shareable link — all at a flat <strong className="text-amber-300 font-semibold">₹299</strong> with zero watermarks.
                </p>
          ...
          <div className="max-w-[1400px] mx-auto px-4 md:px-8">
            <FadeIn className="text-center mb-10 md:mb-14">
              ...
              <h2 className="font-display text-[clamp(2rem,4vw,3rem)] text-[var(--ink)] mb-3">
                {templatesList.length} Luxury Designs — ₹299 Flat
              </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-12 border-b border-white/10 text-sm">
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2.5 text-stone-300 font-light">
                ...
                <li className="flex items-center gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-amber-400" />
                  <span>Unified ₹299 Flat Pricing</span>
                </li>
              </ul>
            </div>
