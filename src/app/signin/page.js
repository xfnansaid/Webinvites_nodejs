            ...
            <div className="relative">
              ...
              <div className="relative bg-white rounded-3xl shadow-[0_30px_80px_rgba(15,56,44,0.1)] border border-stone-100/80 overflow-hidden">
                ...
                <div className="px-7 sm:px-8 pb-8 sm:pb-10">
                  ...
                  {/* Signed-in welcome */}
                  {signedIn && (
                    <div className="mb-5 rounded-2xl bg-[var(--emerald-light)]/60 border border-[var(--emerald-primary)]/10 px-4 py-4 text-[13px] text-[var(--emerald-dark)] leading-relaxed flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <div className="opacity-80">Redirecting you in a moment…</div>
                      </div>
                    </div>
                  )}
