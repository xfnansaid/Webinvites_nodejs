...
export async function GET(request) {
  ...
  try {
    ...
    // Entitlement Rules:
    // 1. User can have at most 1 active free template at any time (freePublishedCount === 0).
    // 2. When they delete their free template from dashboard, freePublishedCount becomes 0, unlocking another free publish.
    // 3. While an active free template exists, any additional template publish requires paying ₹399.
