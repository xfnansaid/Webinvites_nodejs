  ...
  const templateData = useMemo(() => {
    ...
    if (templateType === 'birthday') {
      return {
        ...
        celebrantName: formData.celebrantName || base.celebrantName || 'Aarav',
        age: formData.age || base.age || '5',
        birthdayDate: formData.birthdayDate || base.birthdayDate || '2026-12-20',
        birthdayTime: formData.birthdayTime || base.birthdayTime || '4:00 PM',
        ...
        // Also map weddingDate → birthdayDate as fallback (if form has weddingDate)
        ...(formData.weddingDate && !formData.birthdayDate ? { birthdayDate: formData.weddingDate } : {}),
        ...(formData.weddingTime && !formData.birthdayTime ? { birthdayTime: formData.weddingTime } : {}),
      };
    }
    ...
    if (templateType === 'housewarming') {
      return {
        ...
        familyName: formData.familyName || base.familyName || 'The Sharma Family',
        eventDate: formData.eventDate || base.eventDate || '2026-12-20',
        eventTime: formData.eventTime || base.eventTime || '11:00 AM',
        hostsName: formData.hostsName || base.hostsName || '',
        ...
        // Also map weddingDate → eventDate as fallback
        ...(formData.weddingDate && !formData.eventDate ? { eventDate: formData.weddingDate } : {}),
        ...(formData.weddingTime && !formData.eventTime ? { eventTime: formData.weddingTime } : {}),
      };
    }
