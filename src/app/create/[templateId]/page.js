...
export default function CreatePage() {
  ...
  return (
    <>
      ...
      <header className="bg-white/95 backdrop-blur-xl border-b border-[var(--border-subtle)] sticky top-0 z-[90] px-3 sm:px-4 md:px-8 py-2.5 sm:py-3 md:py-4 shadow-[0_1px_0_rgba(0,0,0,0.02)]">
        <div className="max-w-[1400px] mx-auto flex items-center justify-between gap-2 sm:gap-3">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 md:gap-3 shrink-0">
            {/* Step Indicator */}
            <div className="hidden sm:inline-flex items-center gap-1.5 px-3 py-2 bg-gray-50 rounded-xl border border-gray-100 min-h-[40px]">
              <div className={`w-6 h-6 rounded-full flex items-center justify-center text-[11px] font-bold transition-all ${step >= 1 ? 'bg-[var(--emerald-primary)] text-white' : 'bg-gray-200 text-gray-500'}`}>1</div>
              <div className={`w-8 h-[2px] rounded-full ${step >= 2 ? 'bg-[var(--emerald-primary)]' : 'bg-gray-200'}`}></div>
              <div className={`w-6 h-6 rounded-full flex items-center justify-center text-[11px] font-bold transition-all ${step >= 2 ? 'bg-[var(--emerald-primary)] text-white' : 'bg-gray-200 text-gray-500'}`}>2</div>
            </div>
            <div className="sm:hidden inline-flex items-center gap-1.5 px-2.5 py-1.5 bg-gray-50 rounded-xl border border-gray-100 min-h-[36px]">
              <span className="text-[10px] font-bold text-[var(--ink-muted)] uppercase tracking-wider">Step</span>
              <span className="text-[11px] font-bold text-[var(--ink)]">{step}/2</span>
            </div>
      ...
      <main className={`max-w-[1400px] mx-auto px-3 sm:px-4 md:px-8 pt-4 sm:pt-6 md:pt-8 ${step === 1 ? 'pb-[200px]' : 'pb-[260px]'}`}>
        ...
        {step === 1 && (
          <div className="flex flex-col items-center">
           ...
           {/* Phone Preview — the STAR of Step 1 */}
              ...
              <div className="relative w-full px-4 sm:px-0">
                ...
                <div
                  className="
                    ...
                    max-w-[440px]
                    mx-auto
                    /* DESKTOP (sm+): LOCKED to exact iPhone viewport 393x852 */
                    sm:max-w-none
                    sm:w-[393px]
                    sm:h-[852px]
                    sm:aspect-auto
            ...
            {/* Step 1 Sticky Next Button */}
            <div className="fixed bottom-0 left-0 right-0 z-[90] bg-white/95 backdrop-blur-xl border-t border-[var(--border-subtle)] shadow-[0_-10px_40px_rgba(15,56,44,0.08)] p-3.5 sm:p-4 pb-[calc(env(safe-area-inset-bottom)+14px)] pointer-events-auto">
              <div className="max-w-[1200px] mx-auto flex flex-col sm:flex-row items-center justify-between gap-3">
                <div className="hidden sm:flex items-center gap-3 text-left">
                  <div className="w-10 h-10 rounded-2xl bg-[var(--emerald-light)] flex items-center justify-center shrink-0">
                    <Palette className="w-5 h-5 text-[var(--emerald-primary)]" />
                  </div>
                  <div className="min-w-0">
                    <div className="text-sm font-bold text-[var(--ink)]">Happy with your design?</div>
                    <div className="text-xs text-[var(--ink-muted)]">Fill the final details & publish your invitation</div>
                  </div>
                </div>
                <div className="sm:hidden w-full text-center mb-0.5">
                  <p className="text-[11px] font-bold text-[var(--ink-muted)] uppercase tracking-[0.1em]">Ready when you are</p>
                </div>
                <div className="flex items-center gap-2.5 w-full sm:w-auto">
                  <button
                    onClick={() => setStep(2)}
                    className="flex-1 sm:flex-none sm:min-w-[200px] inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-3 sm:py-3.5 bg-[var(--emerald-primary)] text-white rounded-2xl font-bold text-sm sm:text-base hover:bg-[var(--emerald-dark)] transition-all shadow-xl shadow-[var(--emerald-primary)]/25 active:scale-[0.98] group"
                  >
                    Next — Final Details
                    <ArrowRight className="w-[18px] h-[18px] sm:w-5 sm:h-5 transition-transform group-hover:translate-x-1" />
                  </button>
                </div>
              </div>
            </div>
